...
export default function Sigin() {
  ...
  const onSubmit: SubmitHandler<LoginFormInputs> = async data => {
    try {
      ...
      toast.error("Erro ao realizar login: " + error.response.data.message);
    }
  };
  ...
  return (
    <div className={styles.container}>
      ...
      <form
        ...
        className={styles.modal__container__form}
      >
        ...
        <div className={styles.modal__envolve__buttons}>
          <ButtonForm variant="flatButton" type="submit">
            Entrar
          </ButtonForm>
          <ButtonForm variant="outline" type="button" onClick={SignUpPage}>
            Cadastre-se
          </ButtonForm>
        </div>
      </form>
